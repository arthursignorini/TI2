...
public class Aplicacao {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("\n\n==== Inserir usuário === ");
		Usuario usuario = new Usuario(11, "arthur", "arthur",'M');
		if(usuarioDAO.insert(usuario) == true) {
			System.out.println("Inserção com sucesso -> " + usuario.toString());
		}
		
		System.out.println("\n\n==== Testando autenticação ===");
		System.out.println("Usuário (" + usuario.getLogin() + "): " + usuarioDAO.autenticar("arthur", "arthur"));
		...
		usuario.setSenha(DAO.toMD5("arthur"));
		usuarioDAO.update(usuario);
		
		System.out.println("\n\n==== Testando autenticação ===");
		System.out.println("Usuário (" + usuario.getLogin() + "): " + usuarioDAO.autenticar("arthur", DAO.toMD5("arthur")));		
		
		System.out.println("\n\n==== Invadir usando SQL Injection ===");
		System.out.println("Usuário (" + usuario.getLogin() + "): " + usuarioDAO.autenticar("arthur", "x' OR 'x' LIKE 'x"));
